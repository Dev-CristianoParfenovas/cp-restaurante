      ...
      if lbl_edtVlrPagto.Text <> '' Then begin// se for em branco executa rotina abaixo.
        ...
        if (Pos(',',lbl_edtVlrPagto.Text)>0) and (lbl_edtVlrPagto.Text <> '') Then begin
          ...
          if (lbl_edtVlrPagtoP.Text > '0')or(lbl_edtVlrPagtoP.Text > '0,00') Then begin
            ...
            Valor1 := StrToFloat(StringReplace(lbl_edtVlrPagto.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));

            Valor2 := StrToFloat(StringReplace(lbl_edtVlrPagtoP.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
        ...
        if(lbl_edtVlrPendente.Text >'0')or(lbl_edtVlrPendente.Text >'0,00')then begin
          ...
          Valor3 := StrToFloat(StringReplace(lbl_edtTotal.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
      ...
      if intConfirmaPagto.IntConfirmaPagto = 6 then begin
        ...
        try
          ...
          if(intIDVendas > 0 )then begin
            ...
            strVlrPagtoP.VlrPagtoP := StringReplace(lbl_edtVlrPagto.Text,FormatSettings.ThousandSeparator,'',[rfReplaceAll]);
            strVlrPagtoP.VlrPagtoP := StringReplace(strVlrPagtoP.VlrPagtoP,FormatSettings.DecimalSeparator,'.',[rfReplaceAll]);
