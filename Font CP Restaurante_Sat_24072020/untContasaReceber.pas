...
begin
  ...
  ConfirmaExclusao := Application.MessageBox('Atenção este procedimento retorna o contas a receber do período determinado, deseja continuar??','Retorno do Contas a receber',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
...
begin
  ...
  ConfirmaExclusao := Application.MessageBox('Atenção este procedimento baixa o contas a receber selecionado, deseja continuar??','Baixa do Contas a receber',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
...
begin
  ...
  ConfirmaExclusao := Application.MessageBox('Atenção este procedimento retorna o contas a receber selecionado, deseja continuar??','Retorno do Contas a Receber',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
