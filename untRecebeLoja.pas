...
//****************************************************************************//
  ...
  //    + 'INNER JOIN CADPRODUTOS ON TBLIMPOSTO_IBPT.CODIGO=CADPRODUTOS.NCM
                          ...
                          rTotalVlrVenda := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
                          ...
                          rTotalQtde     := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('QTDE').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
//****************************************************************************//
                      ...
                      RVlrUnit  := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('VLRUNIT').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
                      VLrUnit   := FormatFloat(CasasDecimais('Combustiveis'),RVlrUnit);//StringReplace(FloatToStr(RVlrUnit),ThousandSeparator,'',[rfReplaceAll]);


                      RVlrTotal := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('VLRTOTAL').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
                      ...
                      RQtde     := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('QTDE').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
               ...
               // Writeln(11F,(FormatFloat(CasasDecimais('Combustiveis'),ibTempVendaLoja.FieldByName('QTDE').AsFloat))+' X '+(FormatFloat(CasasDecimais('Produtos'),ibTempVendaLoja.FieldByName('VLRUNIT').AsFloat))+' = '+(FormatFloat(CasasDecimais('Produtos'),ibTempVendaLoja.FieldByName('VLRTOTAL').AsFloat)));
                   ...
                   { if QtdedeItens = 0 Then begin
                    ...
                    if QtdedeItens = 0 Then begin
                      ...
                      QtdedeItens := StrToFloat(StringReplace(FloatToStr(ibRestaurante.FieldByName('QTDE').AsFloat),FormatSettings.ThousandSeparator,'',[rfreplaceAll]));

                    end else begin

                      TotalQtdeItens := StringReplace(FloatToStr(ibRestaurante.FieldByName('QTDE').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]);
