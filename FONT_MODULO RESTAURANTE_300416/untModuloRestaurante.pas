...
type
  TfrmRestaurante = class(TForm)
    ...
    procedure estedeImpresso1Click(Sender: TObject);
...
begin
  ...
  if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa1.Caption = 'Livre') Then begin
    ...
    if (lbl_Informacao.Caption = '')and(lbl_edtNMesa.Text = '')Then begin
     ...
     { if(lbl_Informacao.Caption = 'Liberar Mesa') then begin
...
////////////////////////////////////////////////////////////////////////////////
      ...
      end else if (lbl_Informacao.Caption = 'Abertura de Mesas')then begin
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa1.Caption = 'Ocupada') Then begin
      ...
      lbl_IDCli.Caption := IntToStr(ibRestaurante.FieldByName('IDCLIENTE').AsInteger);
      lbl_Cliente.Caption := ibRestaurante.FieldByName('NOMECLIENTE').AsString;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa4.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa5.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa6.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa7.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa8.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa9.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa10.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa11.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa12.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa13.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa14.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa15.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa16.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa17.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa18.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa19.Caption = 'Ocupada') Then begin
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if (lbl_edtIDDetalheMesa.Caption >'0')and(ckMesa20.Caption = 'Ocupada') Then begin
...
//----------------------------------------------------------------------------//
     ...
     ///   cboProdutos.ClearSelection;
      ...
      VK_F6:begin
        ...
        ConfirmaCancelamento := Application.MessageBox('Confirma o Cancelamento das Mesas?','Cancelamento de Mesas',+MB_YESNO+MB_DEFBUTTON1+MB_ICONQUESTION);
...
////////////////////////////////////////////////////////////////////////////////
          ...
          if lbl_edtIDDetalheMesa.Caption > '0' Then begin
            ...
            +'(MESA,IDDETALHER,DATA,NOMEPRODUTO,IDPRODUTO,IDCLIENTE,NOMECLIENTE,'
            + 'CODBARRAS,REF,VLRUNIT,QTDE,VLRTOTAL) values '
            +'(''' + lbl_edtNMesa.Text + ''','
            + ' ''' + IntToStr(IDDetalheR) + ''','
            + ' ''' + FormatDateTime('mm-dd-yyyy',Now) + ''','
...
MontaColunas := True;
 ...
 if FileExists(PathSistema + 'Data\RunTime\Imagens_Sistema\NovoFundoCX2.gif') Then
    ...
    btF8.Font.Style := [fsBold];
    btF8.Caption := 'SELECIONA'+#13+'PRODUTO'+#13+'(F8)';


    btF9.Font.Style := [fsBold];
    btF9.Caption := 'CANCELA'+#13+'PRODUTO'+#13+'(F9)';

    btLimparMesas.Font.Style := [fsBold];
    btLimparMesas.Caption := 'LIMPAR'+#13+'MESAS'+#13+'CTLR-M';
    ...
    if key=#13 Then begin
     ...
     /// IDServs         := ibServsVenda.FieldByName('IDSERVS').AsInteger;
      ...
      if ibRestaurante.RecordCount > 0 Then begin
        ...
        lbl_edtIDProduto.Text   := IntToStr(ibRestaurante.FieldByName('IDPRODUTO').AsInteger);
...
tedit(sender).color := clwindow;
  with dmModule do begin
    ...
    if lbl_edtNMesa.Text = '' Then begin
      ...
      Application.MessageBox('Para lançamento é necessário abrir mesa','Informação',+MB_OK+MB_DEFBUTTON1+MB_ICONINFORMATION);
...
procedure TfrmRestaurante.estedeImpresso1Click(Sender: TObject);
begin
