...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, IBQuery, RxGIF;
    ...
    lbl_edtPorcentagemGarcom.SetFocus;
      ...
      if lbl_TotalMesas.Caption <> '' Then begin //se for em branco executa rotina abaixo.
        ...
        if (Pos(',',lbl_TotalMesas.Caption)>0) and (lbl_TotalMesas.Caption > '0,00') Then begin
          ...
          Valor1 := StrToFloat(StringReplace(lbl_TotalMesas.Caption,ThousandSeparator,'',[rfReplaceAll]));
          Valor2 := StrToFloat(StringReplace(lbl_edtQtdePessoas.Text,ThousandSeparator,'',[rfReplaceAll]));
