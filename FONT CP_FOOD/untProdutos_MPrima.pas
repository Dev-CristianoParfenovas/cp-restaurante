...
uses
  ...
  IniFiles, jpeg, DB,axCtrls, Menus;
...
var
  ...
  intTipoOleo, intNacProd : Integer;
  ...
  with dmModule do begin
    ...
    case Key of
        ...
        VK_F5 :begin
          ...
          ibProdutos.Close;
          ibProdutos.SQL.Clear;
          ibProdutos.SQL.Add('SELECT * FROM CADPRODUTOS ORDER BY CODBARRAS');
          ibProdutos.Open;
     ...
     //end;//case
        ...
        VK_F6 :begin
          ...
          ibProdutos.Close;
          ibProdutos.SQL.Clear;
          ibProdutos.SQL.Add('SELECT * FROM CADPRODUTOS ORDER BY IDPROD');
          ibProdutos.Open;
