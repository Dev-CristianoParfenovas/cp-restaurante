...
uses
  ...
  Dialogs, RxGIF, ExtCtrls, StdCtrls, classComboBox, Buttons;
...
IDFuncCx, IDCadCx, ConfirmaMSG : Integer;
...
////////////////////////////////////////////////////////////////////////////////   and(ibAbrePista.FieldByName('IDFUNC').AsInteger='' + StrToInt(IDClassUsuario.ID) +  '')
      ...
      if (DataAbertura = DataAtual)  and (HoraFech = 0) and (IDFuncCx > 0) Then begin
        ...
        if ConfirmaMSG = 6 Then begin
          ...
          frmSenhaCX.Close;
       ///   NomeFunc := ibUser.FieldByName('LOGIN').AsString;
        ///  frmCliente.lbl_Func.Caption := NomeFunc;
...
////////////////////////////////////////////////////////////////////////////////
     ...
     //   (DataAbertura = DataAtual)  and (HoraFech > 0) and (IDFunc > 0) Then begin
        ...
        if ConfirmaMSG = 6 Then begin
          ...
          TrocoInicial := StringReplace(lbl_edtTrocoInicial.Text,ThousandSeparator,'',[rfReplaceAll]);
          TrocoInicial := StringReplace(TrocoInicial,DecimalSeparator,'.',[rfReplaceAll]);
        ...
        {  ibServsVenda.Close;
          ...
          frmCliente.ShowModal; // no meu caso uso sempre modal
          FreeAndNil(frmCliente); // efetua o Free no Form e também limpa o setor de memoria que foi alocado por ele
