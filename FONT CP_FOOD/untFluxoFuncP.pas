...
uses
  ...
  Dialogs, RxGIF, ExtCtrls, StdCtrls, ComCtrls, BmsXPButton,
        ...
        ibAberturaCX.Open;
          ...
          while not ibAberturaCX.Eof do begin//enquanto nao for fim de registro
            ...
            if (TrocoInicial = 0) Then begin//se variavel for igual a zero
              ...
              //atribui o vlr do campo abaixo na variavel
             TrocoInicial := StrtoFloat(StringReplace(FloattoStr(ibAberturaCX.FieldByName('TROCOINICIAL').AsFloat),ThousandSeparator,'',[rfReplaceAll]));

            end else begin

              //atribui na variavel substituindo o ponto para vlr em branco
              TotalTrocoIni := StringReplace(FloattoStr(ibAberturaCX.FieldByName('TROCOINICIAL').AsFloat),ThousandSeparator,'',[rfReplaceAll]);
