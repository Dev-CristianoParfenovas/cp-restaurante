...
uses
  ...
  classComboBox, Menus, axCtrls, ComCtrls,
  untClasse.Cadastro, untClasse.VendasCX, IniFiles, Data.DB,
...
uses untdmModule, uBuscaProdutos, funcPosto, untRecebeLoja,
...
intSATDaruma, intSatGeral : Integer;
      ...
      VK_F3:begin
          ...
          if (intSatGeral = 1)and(intSATDaruma = 0) then begin
            ...
            try
              ...
              Ini.WriteString('TotalVenda','VlrTotal',lbl_ValorTotal.Caption);
              Ini.WriteString('Cupom','NCupom',lbl_edtIDDetalheMesa.Caption);
              ...
              Ini.Free;
              frmRestaurante.lbl_edtVlrUnit.Text  := '0,00';
              frmRestaurante.lbl_edtVlrTotal.Text := '0,00';
              frmRestaurante.lbl_ValorTotal.Caption := '0,00';
              frmRestaurante.lbl_Informacao.Caption := 'Caixa Livre';
              frmRestaurante.lbl_edtQtde.Text := '1';
            //  frmRestaurante.lbl_edtCodBarras.Enabled := False;
            //  frmRestaurante.lbl_edtRef.Enabled := False;
          ...
          if (intSatGeral = 0)and(intSATDaruma = 1) then begin
...
////////////////////////////////////////////////////////////////////////////////
      ...
      if lbl_edtIDDetalheMesa.Caption > '0' Then begin
       ...
       // if ConfirmaCupomInteiro = 6 Then begin
          ...
          QtdeVendaDevolve   := StrtoFloat(StringReplace(FloattoStr(ibRestaurante.FieldByName('QTDE').AsFloat),FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
...
/////////////////////////////////////////////////////////////////////////////////
      if lbl_edtVlrTotal.Text <> '' Then begin// se for em branco executa rotina abaixo.
        ...
        if (Pos(',',lbl_edtVlrTotal.Text)>0) and (lbl_edtVlrTotal.Text <> '') Then begin
          ...
          //Valor1 := StrToFloat(StringReplace(lbl_edtTotalPed.Text,ThousandSeparator,'',[rfReplaceAll]));
          Valor2 := StrToFloat(StringReplace(lbl_ValorTotal.Caption,FormatSettings.ThousandSeparator,'',[rfReplaceAll]));
          Valor3 := (Valor2 + Valor1);
...
MontaColunas := True;
 ...
 //if FileExists(PathSistema + 'Data\RunTime\Imagens_Sistema\NovoFundoCX2.gif') Then
  //  imgFundoCx.Picture.LoadFromFile(PathSistema + 'Data\RunTime\Imagens_Sistema\NovoFundoCX2.gif');
    ...
    btF5.Caption := 'Aaguardar'+#13+'Fech.'+#13+'(F5)';
    ...
    btF8.Caption := 'Seleciona'+#13+'Produto'+#13+'na Grade';


    btF9.Font.Style := [fsBold];                       // +#13+'(F9)'
    btF9.Caption := 'Cancela'+#13+'Produto' +#13+ 'Selec.';
    ...
    btF1.Font.Size := 8;
    btCancelarCupomSat.Caption := 'Cancela'+#13+ 'Última Venda'+#13+'CTRL-D';

    btImprimeUltimoCupom.Font.Style := [fsBold];
    btImprimeUltimoCupom.Caption := 'Imprime'+#13+ 'Última Venda'+#13+'CTRL-U';

    btVendaB.Font.Style := [fsBold];
    btVendaB.Caption := 'Venda(B)'+#13+'(F8)';

    btVendaC.Font.Style := [fsBold];
    btVendaC.Caption := 'Venda(C)'+#13+'(F9)';

    btFunc.Font.Style := [fsBold];
    btFunc.Caption := 'Incluir'+#13+ 'Funcionário'+#13+'CTRL-F';

    btLimpaFunc.Font.Style := [fsBold];
    btLimpaFunc.Caption := 'Limpa campo'+#13+ 'Funcionário';

    btManutCupons.Font.Style := [fsBold];
    btManutCupons.Caption := 'Manut.de'+#13+ 'Cupons'+#13+'(F11)';
