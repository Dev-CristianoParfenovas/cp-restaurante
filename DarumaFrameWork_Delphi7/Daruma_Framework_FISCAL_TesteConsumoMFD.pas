...
var
  ...
  Str_TimeInicial : String; //Recebe o time Inicial
  Str_TimeFinal : String; //Recebe o time Final
  Str_DescricaoRamdom :String; //recebe a string da descricao ramdomica
  Str_CodigoRamdom : String; //recebe a string do codigo ramdomico
  Str_NumeroLinhas : String;
  Int_ContaRamdom : Integer; //contador para gerar randomico
  Int_Tamanho : Integer;

  Str_GT: string; //recebe o Grande Total
  Str_SubTotal:string; //recebe o SubTotal
  Str_StatusCupom:string; //recebe o Status do Cupom Fiscal (1)Aberto e (0)Fechado
          ...
          If (StrToInt(Str_NumeroLinhas) = 1) Then
                ...
                begin
                  ...
                  While (Int_ContaRamdom <> LB_LogCodigo.Count) do
                    begin
                      ...
                      Int_Retorno := iCFVenderResumido_ECF_Daruma(pchar('II'), pchar('0,100'), LB_LogCodigo.Items.Strings[Int_ContaRamdom], LB_LogDescricao.Items.Strings[Int_ContaRamdom]);
                ...
                begin
                  ...
                  While (Int_ContaRamdom <> 0) do
                    begin
                      Str_CodigoRamdom := Str_CodigoRamdom +
                                          IntToStr(Trunc(Length(TX_CodigoAleatorio.Text) * Random));
                      Int_ContaRamdom := (Int_ContaRamdom - 1);
                    end;
                  ...
                  While (Int_ContaRamdom <> 0) do
                    begin
                      ...
                      Str_DescricaoRamdom := Str_DescricaoRamdom + copy(TX_DescricaoAleatoria.Text, Int_Tamanho, 1);
                      Int_ContaRamdom := (Int_ContaRamdom - 1);
                    end;
                    if(PerguntarLigada.Checked=true)then
                    begin
                  ...
                  Int_Retorno := iCFVenderResumido_ECF_Daruma(pchar('II'), pchar('0,10'), Str_CodigoRamdom,Str_DescricaoRamdom);
              ...
              If (False) Then
                begin
                    ...
                    begin
                      ...
                      Int_Retorno := iCFVenderResumido_ECF_Daruma(pchar('II'), pchar('0,10'), pchar('1234567890123'), pchar('teste de vende item'));
                end;
            ...
            begin
                    ...
                    begin
                      ...
                      Int_Retorno := iCFVenderResumido_ECF_Daruma(pchar('II'), pchar('1,00'), pchar('1234567890123'), pchar('Minha Caneta, Mi Bolígrafo'));
                        if(PerguntarSubTotal.Checked=true)then
                        begin
                          SetLength(Str_SubTotal,20);
                          Int_RetornoFuncao := rCFSubtotal_ECF_Daruma(Str_Subtotal);
...
begin
  ...
  rRetornarInformacao_ECF_Daruma('103',Str_InformacaoMFD);
  ...
  rRetornarInformacao_ECF_Daruma('104', Str_InformacaoMFD);
...
function TFR_FISCAL_Teste_Consumo_MFD.HexToDecimal(HexNumber : string) : integer;
var
