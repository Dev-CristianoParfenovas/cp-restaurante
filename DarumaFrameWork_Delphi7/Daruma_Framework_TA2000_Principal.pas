...
begin
  ...
  if ((boRetorno = True) and (stPorta <> '')) then
    begin
      iRetorno := regPorta_TA2000_Daruma(stPorta);
      if (iRetorno = 1) then
        begin
...
begin
  ...
  if ((boRetorno = True) and (stMensagem <> '')) then
    begin
      iRetorno := regMensagemBoasVindasLinha1_TA2000_Daruma(stMensagem);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMensagem2 <> '')) then
    begin
      iRetorno := regMensagemBoasVindasLinha2_TA2000_Daruma(stMensagem2);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMarcadorOpcao <> '')) then
    begin
      iRetorno := regMarcadorOpcao_TA2000_Daruma(stMarcadorOpcao);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMascara <> '')) then
    begin
      iRetorno := regMascara_TA2000_Daruma(stMascara);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMascaraLetra <> '')) then
    begin
      iRetorno := regMascaraLetra_TA2000_Daruma(stMascaraLetra);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMascaraNumero <> '')) then
    begin
      iRetorno := regMascaraNumero_TA2000_Daruma(stMascaraNumero);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
...
begin
  ...
  if ((boRetorno = True) and (stMascaraEco <> '')) then
    begin
      iRetorno :=  regMascaraEco_TA2000_Daruma(stMascaraEco);
      if (iRetorno = 1) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
