...
type
  TFR_MenuImpressoraDual_Principal = class(TForm)
    ...
    MN_rConsultaStatusImpressora_DUAL_DarumaFramework: TMenuItem;
    ...
    procedure MN_rConsultaStatusImpressora_DUAL_DarumaFrameworkClick(
      Sender: TObject);
 //   procedure Bob35BufferClick(Sender: TObject);
  private
...
begin
  ...
  boRetorno := InputQuery('Daruma DLL Framework',
                          'Selecione a velocidade de comunicação com a impressora:',
                           stVelocidade);
  if ((boRetorno = True) and (stVelocidade <> '')) then
    begin
      iRetorno := regVelocidade_DUAL_DarumaFramework(stVelocidade);
      if ((iRetorno = 1) and
          ((stVelocidade = '1200') or
           (stVelocidade = '2400') or
           (stVelocidade = '300') or
           (stVelocidade = '4800') or
           (stVelocidade = '57600') or
           (stVelocidade = '19200') or
           (stVelocidade = '38400') or
           (stVelocidade = '115200') or
           (stVelocidade = '9600'))) then
        begin
          Application.MessageBox('Configuração realizada com sucesso.', 'Daruma DLL Framework', MB_OK + MB_ICONINFORMATION);
        end
      else
...
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e><b>CENTRO DE DANÇA FLASH</b></e></ce>'),0);
//IMPRIMINDO A SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<l></l><tc>~</tc>'),0);
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Rua: XV de Novembro N 785 Centro SP BR' +
//IMPRIMINDO A QUARTA LINHA
'Fone: 6234-5678 Fax:6324-5678'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Data: <dt></dt><tb><tb>Hora: <hr></hr>'),0);
//IMPRIMINDO A SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Pedido:00069 Cliente:00013' + #13+#10+
...
iRetorno:=iImprimirTexto_DUAL_DarumaFramework(pchar('<bmp></bmp><ean8><w3>1234567</w3></ean8>' +
...
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ad>Obrigado.</ad>'),0);
//IMPRIMINDO A DECIMA SEXTA LINHA

iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<bmp></bmp>'),0);

iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<sl>3</sl><sn></sn>'),0);
...
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb><i>Jardim Social   -   Curitiba   -  PR</i>'),0);
//IMPRIMINDO A QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>CNPJ 04.888.968/0001-79<tb><e>234-5678<l></l></e>'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>#</tc><l></l>'),0);
//IMPRIMINDO A SEXTA LINHA
...
//IMPRIMINDO A OITAVA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Nome : </c><b>ELAINE MARIA</b><sp>5</sp>(545)<l></l> '),0);
//IMPRIMINDO A NONA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Plano : </c><b>MUSCULAÇÃO NOTURNO</b><sp>5</sp>(5)<l></l>'),0);
//IMPRIMINDO A DECIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>VALOR PAGO : 45,00</e></ce>'),0);
//IMPRIMINDO A DECIMA PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Ref. ao período de 03/04/2005 até 03/05/2005</c><l></l>'),0);
//IMPRIMINDO A DECIMA SEGUNDA LINHA
...
//IMPRIMINDO A DECIMA QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>WWW.ACADEMIANEW.COM.BR</e></ce>'),0);
//IMPRIMINDO A DECIMA QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>_</tc><l></l>'),0);
//IMPRIMINDO A DECIMA SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>SAUDE BELEZA E BEM ESTAR</e></ce>'),0);
...
begin
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb><b>FRAB<tb>Ano<tb>Modelo<tb>Valor<tb>Cor</b>'),0);
//IMPRIMINDO A PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>2000<tb>Corsa<tb>12.000<tb>Azul'),0);
//IMPRIMINDO A SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Ford<tb>2005<tb>Fiesta<tb>14.000<tb>Verde'),0);
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Fiat<tb>1998<tb>Uno Mille<tb>9.000<tb>Branco'),0);
//IMPRIMINDO A QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>1997<tb>Vectra<tb>18.000<tb>Prata'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>1999<tb>Tigra<tb>17.000<tb>Verde'),0);
//IMPRIMINDO A SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Ford<tb>2001<tb>Versalhes<tb>5.000<tb>Vinho'),0);
//IMPRIMINDO A SÉTIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>1998<tb>Corsa<tb>10.000<tb>Preto'),0);
//IMPRIMINDO A OITAVA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Fiat<tb>1996<tb>Fiurino<tb>6.000<tb>Branca'),0);
//IMPRIMINDO A NONA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>WV<tb>1979<tb>Fusca<tb>3.000<tb>Bordo'),0);
//IMPRIMINDO A DECIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>1996<tb>Vectra<tb>16.000<tb>Grafite'),0);
//IMPRIMINDO A DECIMA PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Fiat<tb>1985<tb>Fiat147<tb>3.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Hond<tb>2003<tb>Civic<tb>28.000<tb>Preto'),0);
//IMPRIMINDO A DECIMA TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Fiat<tb>1999<tb>Palio<tb>12.000<tb>Cinza'),0);
//IMPRIMINDO A DECIMA QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>GM<tb>2003<tb>Celta<tb>17.000<tb>Branco<sl>7</sl>'),0);
...
begin
  ...
  if ((boRetorno = True) and (stLinhas <> '')) then
    begin
      iRetorno := regTabulacao_DUAL_DarumaFramework(stLinhas);
      if (iRetorno = 1) then
        begin
...
begin
 ...
 procedure TFR_MenuImpressoraDual_Principal.Bob35BufferClick(
  Sender: TObject);
...
//IMPRIMINDO A PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<bmp></bmp>'),0);
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e><b>CENTRO DE DANÇA</b></e></ce>'),0);

iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e><b>FLASH</b></e></ce>'),0);

//IMPRIMINDO A SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<l></l><tc>~</tc>'),0);
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Rua: XV de Novembro N 785 Centro SP' + #13+#10+
//IMPRIMINDO A QUARTA LINHA
'Fone: 6234-5678 Fax:6324-5678'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Data: <dt></dt><tb><tb>Hora:<hr></hr>'),0);
...
iRetorno:=iImprimirTexto_DUAL_DarumaFramework(pchar('<ean8><w3>1234567</w3></ean8>' +
'<upc-a><txt>12345678912</txt></upc-a>' +
'<code39><txt>12345678A-B-Z*F-E-H*</txt></code39>' +
'<code93><txt>12345678A-B-Z-F&</txt></code93>' +
'<codabar><txt>12345678A$$</txt></codabar>' +
...
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<sl>3</sl>'),0);
...
iRetorno: Integer;
begin
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<b>FABR<tb>Ano<tb>Modelo<tb>Valor<tb>Cor</b>'),0);
//IMPRIMINDO A PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>2000<tb>Corsa<tb>12.000<tb>Azul'),0);
//IMPRIMINDO A SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Ford<tb>2005<tb>Fiesta<tb>14.000<tb>Azul'),0);
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Fiat<tb>1998<tb>Uno<tb>9.000<tb>Azul'),0);
//IMPRIMINDO A QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>1997<tb>Vectra<tb>18.000<tb>Azul'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>1999<tb>Tigra<tb>17.000<tb>Azul'),0);
//IMPRIMINDO A SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Ford<tb>2001<tb>Ka<tb>5.000<tb>Azul'),0);
//IMPRIMINDO A SÉTIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>1998<tb>Corsa<tb>10.000<tb>Azul'),0);
//IMPRIMINDO A OITAVA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Fiat<tb>1996<tb>Fiurino<tb>6.000<tb>Azul'),0);
//IMPRIMINDO A NONA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('WV<tb>1979<tb>Fusca<tb>3.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>1996<tb>Vectra<tb>16.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Fiat<tb>1985<tb>Fiat147<tb>3.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Hond<tb>2003<tb>Civic<tb>28.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('Fiat<tb>1999<tb>Palio<tb>12.000<tb>Azul'),0);
//IMPRIMINDO A DECIMA QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('GM<tb>2003<tb>Celta<tb>17.000<tb>Azul<sl>7</sl>'),0);
...
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>#</tc>'),0);
//IMPRIMINDO A PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<e>  ACADEMIA NEW</e>'),0);
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<e>    SPORTS</e>'),0);
//IMPRIMINDO A SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb><i>Rua Nossa Sra. da Luz</i>, 350'),0);
//IMPRIMINDO A TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb><i>Jardim Social - Curitiba - PR</i>'),0);
//IMPRIMINDO A QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>CNPJ 04.888.968/0001-79<l></l>'),0);
//IMPRIMINDO A QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>#</tc><l></l>'),0);
//IMPRIMINDO A SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<i><dt></dt><i>'),0);
//IMPRIMINDO A SÉTIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tb>Recibo nr.258963<l></l>'),0);
//IMPRIMINDO A OITAVA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Nome : </c><b>ELAINE MARIA</b><sp>5</sp>(545)<l></l> '),0);
//IMPRIMINDO A NONA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Plano : </c><b>MUSCULAÇÃO NOTURNO</b><sp>5</sp>(5)<l></l>'),0);
...
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>VALOR PAGO : 45,00</e></ce>'),0);
//IMPRIMINDO A DECIMA PRIMEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Ref. ao período de 03/04/012 a 03/05/012</c><l></l>'),0);
//IMPRIMINDO A DECIMA SEGUNDA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<c>Obs: MENSALIDADE</c><l></l>'),0);
//IMPRIMINDO A DECIMA TERCEIRA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>_</tc><l></l>'),0);
//IMPRIMINDO A DECIMA QUARTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>WWW.ACADEMIA.COM</e></ce>'),0);
//IMPRIMINDO A DECIMA QUINTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<tc>_</tc><l></l>'),0);
//IMPRIMINDO A DECIMA SEXTA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>SAUDE BELEZA E</e></ce>'),0);
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<ce><e>BEM ESTAR</e></ce>'),0);
//IMPRIMINDO A DECIMA SÉTIMA LINHA
iRetorno:= iImprimirTexto_DUAL_DarumaFramework(pchar('<sl>7</sl>'),0);
...
procedure TFR_MenuImpressoraDual_Principal.MN_rConsultaStatusImpressora_DUAL_DarumaFrameworkClick(
  Sender: TObject);
var
iRetorno: Integer;
str_Indice: String;
...
begin
   str_Retorno:= StringOFChar(#0,32);
   str_Indice := InputBox('DarumaFramework', 'Entre com o índice desejado: (1-8)',  '1');
   if (Str_Indice = '') Then
   begin
      Exit;
      end
   ...
   begin
    str_Tipo:= InputBox('DarumaFramework', 'Entre com o tipo da informação desejada:  (0 - para receber valores, 1- para receber texto)', '1');
    if (str_Tipo = '') then
    begin
      Exit;
      end
    ...
    begin
       ...
       Application.MessageBox(pchar(str_Retorno), 'Daruma Framework', mb_ok + 32);
       if (iRetorno = 1) Then
            Application.MessageBox('Consulta de status realizada com sucesso!', 'Daruma DLL Framework', mb_ok + 32)
            else
            Application.MessageBox(pchar('Erro ao realizar consulta de status! '+ (pchar(IntToStr(iRetorno)))), 'Daruma DLL Framework', mb_ok + 16);
            end;
   end
