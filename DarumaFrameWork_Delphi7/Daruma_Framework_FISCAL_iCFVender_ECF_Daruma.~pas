...
Var Str_Aliquota, Str_Qtde, Str_ValorUnit: String;
Var Str_Tipo_Desc_Acresc, Str_Valor_Desc_Acrec: String;
Var Str_Codigo_Item, Str_UnidadeMedida, Str_Descricao : String;
begin
  ...
  // Int_Retorno := iCFVender_ECF_Daruma(pchar(''), pchar(''), pchar(''), pchar(''), pchar(''), pchar(''), pchar(''), pchar(''));
