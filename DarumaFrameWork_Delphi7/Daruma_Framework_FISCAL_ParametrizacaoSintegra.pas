...
type
  TFR_FISCAL_ParametrizacaoSintegra = class(TForm)
    ...
    procedure BT_LocalArquivosClick(Sender: TObject);
  private
...
procedure TFR_FISCAL_ParametrizacaoSintegra.CMB_CodFinalidadeClick(
  Sender: TObject);
var sFinalidade: string;
begin
   sFinalidade:= CMB_CodFinalidade.Text;
...
begin
   sConvenio:= CMB_Cod_Convenio.Text;
...
procedure TFR_FISCAL_ParametrizacaoSintegra.CMB_NaturezaOpClick(
  Sender: TObject);
var sNatureza: string;
begin
   sNatureza:= CMB_NaturezaOp.Text;
...
var sEndereco, //Tamanho da variavel [100]
    ...
    sCEP :string; //Tamanho da variavel [20]
var sTelefone,
