...
type
  TFR_FISCAL_rGerarMFD = class(TForm)
    GroupBox1: TGroupBox;
    Label3: TLabel;
...
var
  FR_FISCAL_rGerarMFD: TFR_FISCAL_rGerarMFD;
...
procedure TFR_FISCAL_rGerarMFD.BT_Procura_DestinoArqClick(Sender: TObject);
var spathAto:String;
begin
...
procedure TFR_FISCAL_rGerarMFD.BT_ENVIARClick(Sender: TObject);
  var
...
procedure TFR_FISCAL_rGerarMFD.BT_FECHARClick(Sender: TObject);
begin
close();
end;
