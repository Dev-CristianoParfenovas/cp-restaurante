...
type
  TFR_MODEM_rReceberSms = class(TForm)
    ...
    procedure EB_QtidadeMsgModemKeyUp(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
procedure TFR_MODEM_rReceberSms.EB_QtidadeMsgModemKeyUp(Sender: TObject;
...
procedure TFR_MODEM_rReceberSms.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if ( key = VK_F1) then
   ShowMessage('Tecla F1')
