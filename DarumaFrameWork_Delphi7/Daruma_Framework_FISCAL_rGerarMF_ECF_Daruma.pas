unit Daruma_Framework_FISCAL_rGerarMF_ECF_Daruma;
...
type
  TFR_FISCAL_rGerarMF = class(TForm)
    GroupBox1: TGroupBox;
    Label3: TLabel;
...
var
  FR_FISCAL_rGerarMF: TFR_FISCAL_rGerarMF;
...
procedure TFR_FISCAL_rGerarMF.BT_ENVIARClick(Sender: TObject);
  var
 ...
 sTipo:= CBX_Tipo.Text;
   ...
   If ((sTipo = 'COO') or (sTipo = 'CRZ')) then
     ...
     sRelatorio:='';
        ...
        sFim:= EDT_Final.Text;
        Int_Retorno:= rGerarMF_ECF_Daruma(sTipo,sInicio,sFim);
      ...
      begin
        ...
        Int_Retorno:= rGerarMF_ECF_Daruma(sTipo,sDataIni,sDataFim);
        FR_MenuImpressoraFiscal_Principal.DarumaFramework_Mostrar_Retorno(Int_Retorno);
      end;
      end;

procedure TFR_FISCAL_rGerarMF.BT_Procura_DestinoArqClick(Sender: TObject);
var spathAto:String;
begin
...
procedure TFR_FISCAL_rGerarMF.BT_FECHARClick(Sender: TObject);
begin
close();
end;
