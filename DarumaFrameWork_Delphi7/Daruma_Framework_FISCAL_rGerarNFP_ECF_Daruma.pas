unit Daruma_Framework_FISCAL_rGerarNFP_ECF_Daruma;
...
type
  TFR_FISCAL_rGerarNFP = class(TForm)
    GroupBox1: TGroupBox;
    Label3: TLabel;
...
var
  FR_FISCAL_rGerarNFP: TFR_FISCAL_rGerarNFP;
...
procedure TFR_FISCAL_rGerarNFP.BT_FECHARClick(Sender: TObject);
begin
close();
end;

procedure TFR_FISCAL_rGerarNFP.BT_ENVIARClick(Sender: TObject);
  var
 ...
 sTipo:= CBX_Tipo.Text;
   ...
   If ((sTipo = 'COO') or (sTipo = 'CRZ')) then
     ...
     sRelatorio:='';
        ...
        sFim:= EDT_Final.Text;
        Int_Retorno:= rGerarNFP_ECF_Daruma(sTipo,sInicio,sFim);
      ...
      begin
        ...
        Int_Retorno:= rGerarNFP_ECF_Daruma(sTipo,sDataIni,sDataFim);
        FR_MenuImpressoraFiscal_Principal.DarumaFramework_Mostrar_Retorno(Int_Retorno);
      end;
