...
var
  ...
  sRelatorio, spathAto, spathSintegra, spathNFP: string;
...
procedure TFR_FISCAL_rGerarRelatorio.BTN_GerarRelatorioClick(
  Sender: TObject);
var
sTipo, sInicio, sFim, str_LocalArquivos, sArquivoSintegra, sArquivoNFP, sLocalChavePrivada: string;
...
begin
   DLG_SelecionaDiretorio.Execute;
   spathNFP:= ExtractFilePath(DLG_SelecionaDiretorio.FileName);
end;
...
procedure TFR_FISCAL_rGerarRelatorio.Button2Click(Sender: TObject);
  var
sRelatorio, sTipo, sDataIni, sDataFim, sInicio, sFim, sArquivoAtocotepe, sArquivoSintegra, sArquivoNFP, sLocalChavePrivada, Str_Indice: string;
iTam, Int_Confirma:integer;
begin
