...
//Retornos e Status do ECF
		//Retornos
		function rRetornarInformacaoSeparador_ECF_Daruma(pszIndice:string; pszSeparador:string; pszVSignificativo:string; pszRetornar:string): Integer; StdCall; External 'DarumaFramework.dll';
    function rRetornarInformacao_ECF_Daruma(pszIndice:string;pszRetornar:string): Integer; StdCall; External 'DarumaFramework.dll';
		...
		function rInfoEstentida_ECF_Daruma(var int:integer; char:string): Integer; StdCall; External 'DarumaFramework.dll';
...
var IntRet:Integer;
    StrRetLiquido:String;
    StrRetBruto:String;
    FloatValorCalc:real;

begin
    setLength (StrRetLiquido,11);
    setLength (StrRetBruto,11);

    IntRet := regAlterarValor_Daruma('ReceberInfoEstendida', '1');

    //Abertura do CF
    IntRet:=iCFAbrirPadrao_ECF_Daruma();

    IntRet:=iCFVender_ECF_Daruma('FF','1,000','10,00', 'A%', '12,00', '12345', 'un', 'Perfume HG Importado');

    //Valor bruto ultimo item
    IntRet:=rRetornarInformacao_ECF_Daruma('59',StrRetBruto);
    //Valor liquido ultimo item
    IntRet:=rRetornarInformacao_ECF_Daruma('62',StrRetLiquido);
    //Calcumando Acrescimo
    FloatValorCalc:=(StrToFloat(StrRetBruto) - StrToFloat(StrRetLiquido));


    IntRet:=iCFVender_ECF_Daruma('II','1,00','15,00', 'D%', '10,00', '12346', 'UN', 'Camiseta');
    IntRet:=iCFVender_ECF_Daruma('NN','1,00','20,00', 'A%', '12,00', '12347', 'UN', 'Relogio HT Importado');


    IntRet:=iCFVender_ECF_Daruma('18,00','1,00','05,00', 'A%', '00,00', '12348', 'UN', 'Meia');
    IntRet:=iCFVender_ECF_Daruma('II','1,00','30,00', 'A%', '00,00', '12349', 'UN', 'Calsa');
