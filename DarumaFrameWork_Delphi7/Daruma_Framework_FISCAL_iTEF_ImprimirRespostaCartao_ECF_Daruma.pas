...
begin
   ...
   Int_Retorno := iCFVenderResumido_ECF_Daruma(pchar('II'), pchar( '0,10') , pchar('Produto Teste'), pchar('789567893456'));
   Int_Retorno:= iCFTotalizarCupomPadrao_ECF_Daruma();
   Int_Retorno:= iCFEfetuarPagamentoFormatado_ECF_Daruma(Str_Forma_de_Pagamento,Str_Valor_Pagamento);
...
begin
   ...
   if RdgTravarTeclado.ItemIndex = 0 then
     Begin
        Int_Retorno := iTEF_ImprimirRespostaCartao_ECF_Daruma(Str_Path_Arquivo_Resp_TEF,true, Str_Forma_de_Pagamento,Str_Valor_Pagamento);
        FR_MenuImpressoraFiscal_Principal.DarumaFramework_Mostrar_Retorno(Int_Retorno);
     end
     else begin
        Int_Retorno := iTEF_ImprimirRespostaCartao_ECF_Daruma(Str_Path_Arquivo_Resp_TEF,false,Str_Forma_de_Pagamento, Str_Valor_Pagamento);
        FR_MenuImpressoraFiscal_Principal.DarumaFramework_Mostrar_Retorno(Int_Retorno);
     end;
