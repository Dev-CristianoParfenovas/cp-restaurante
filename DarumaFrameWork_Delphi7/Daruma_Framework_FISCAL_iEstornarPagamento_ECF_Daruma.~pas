...
procedure TFR_FISCAL_iEstornarPagamento_ECF_Daruma.BT_ENVIARClick(
  Sender: TObject);
var Str_Formapgtoestornar, Str_Formapgtoefetivado, Str_valor, Str_MsgLivre : string;

begin
   Str_Formapgtoestornar:= Edt_FormaPagtoEstornar.Text;
   Str_Formapgtoefetivado:= Edt_FormaPgtoEfetivado.Text;

   Str_valor:= Edt_Valor.Text;
   Str_MsgLivre:= Edt_MsgLivre.Text;
