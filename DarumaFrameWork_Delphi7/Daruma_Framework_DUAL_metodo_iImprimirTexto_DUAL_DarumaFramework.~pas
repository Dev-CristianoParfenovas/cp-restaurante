...
begin
  ...
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<l>Inserindo<sp>10</sp>10 espaços em Branco', 0);
  ...
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ad>DARUMA AUTOMAÇÃO!!</ad><l>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ce>ALINHADO A DIREITA + EXPANDIDO</ce>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<e><ad>DARUMA AUTOMAÇÃO!!</ad></e><l>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ce>ALINHADO A DIREITA + SUBLINHADO</ce>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ad><s>DARUMA AUTOMAÇÃO!!</s></ad><l>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ce>CENTRALIZADO + EXPANDIDO</ce>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<e><ce>DARUMA AUTOMAÇÃO!!</ce></e><l>', 0);
  iRetorno:= iImprimirTexto_DUAL_DarumaFramework('<ft>05,10,15,20,30,40</ft>', 0);
