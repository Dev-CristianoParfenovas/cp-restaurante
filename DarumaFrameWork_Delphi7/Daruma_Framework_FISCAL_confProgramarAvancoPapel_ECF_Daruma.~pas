...
procedure TFR_FISCAL_confProgramarAvancoPapel_ECF_Daruma.BT_ENVIARClick(
  Sender: TObject);
Var Str_Separacao_Linhas, Str_Separacao_Documentos, Str_Linha_Aciona_Guilhotina, Str_Guilhotina, Str_Cliche : string;
begin
   Str_Separacao_Linhas:= Edt_Separacao_Entre_Linhas.Text;
   Str_Separacao_Documentos:= Edt_Separacao_Entre_Documentos.Text;
   Str_Linha_Aciona_Guilhotina:= Edt_Linha_Aciona_Guilhotina.Text;
